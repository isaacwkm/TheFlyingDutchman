...
public class StoryManager : MonoBehaviour
{
    ...
    public void playStoryScene(int sceneID)
    {
        ...
        currentStoryScene.startStoryScene();
    }

    public void requestDataFromScenes(int callerID, int[] foreignStorySceneIDs)
    {
        ...
        sendDataToScene(callerID, foreignStoryData);
    }

    private void sendDataToScene(int recipientID, Dictionary<int, StoryData> foreignStoryData)
    {
        StoryScenesList[recipientID].setForeignStoryData(foreignStoryData);
    }
}
